...
public interface AttendanceRequestService {
    ...
    PageDTO<AttendanceRequestDTO> findOvertimeRequestsByEmployeeId(Long employeeId, Integer pageNo);
    ...
    PageDTO<AttendanceRequestDTO> findRemoteRequestsByEmployeeId(Long employeeId, Integer pageNo);

    // 사원별 출장 신청 내역 미리보기 조회
    List<AttendanceRequestDTO> findBusinessTripRequestPreviewsByEmployeeId(Long employeeId);

    // 사원별 출장 신청 내역 전체 조회
    PageDTO<AttendanceRequestDTO> findBusinessTripRequestsByEmployeeId(Long employeeId, Integer pageNo);

    // 사원별 파견 신청 내역 미리보기 조회
    List<AttendanceRequestDTO> findDispatchRequestPreviewsByEmployeeId(Long employeeId);

    // 사원별 파견 신청 내역 전체 조회
    PageDTO<AttendanceRequestDTO> findDispatchRequestsByEmployeeId(Long employeeId, Integer pageNo);

    // 사원별 휴직 신청 내역 미리보기 조회
    List<AttendanceRequestDTO> findLeaveRequestPreviewsByEmployeeId(Long employeeId);

    // 사원별 휴직 신청 내역 전체 조회
    PageDTO<AttendanceRequestDTO> findLeaveRequestsByEmployeeId(Long employeeId, Integer pageNo);
